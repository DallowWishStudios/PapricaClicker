...
var item_upgrades = [
	...
	new Item(4, 'Kosa dwustronna', 720, 'Epicka dwustronna kosa wojenna. ', 'kosa_dwustronna.png', 1.2, "sierp", 4),
	new Item(4, 'Kosa Jashin', 60000, 'Umieszczona na sznurze. Ostrza różnej długości mają przede wszystkim służyć do podbierania papryki od przeciwnika, niezbędnej do wykonania rytuału. ', 'jashin.png', 3.2, "sierp", 5),
	items[4],
	...
	new Item(9, 'Topór bitewny', 8600, 'Poręczny wojenny topór. Przydatny w razie egzekucji.', 'topor_bitewny.png', 1.38, "topor", 4),
	new Item(9, 'Topór nordycki', 59700, 'Starożytny topór wojenny. ', 'topor_nordycki.png', 1.6, "topor", 5),
	new Item(9, 'Stormbreaker', 600000, 'Legendarna broń Thora. Nieprzygotowany parob może mieć trudności z zapanowaniem nad jego mocą.', 'stormbreaker.png', 3, "topor", 6),
];
